...
Operations for publishing the `@cordisx/protocol` package itself are maintained
in the [Protocol release runbook](../../maintainers/release.md). They are separate
from the plugin package, source, and activation contracts above.
