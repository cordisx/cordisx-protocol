...
import type { ExtensionPointInteractionCapabilityV1, ExtensionPointRenderCapabilityV1 } from './extension-point-visual.v1.js'
...
export interface PluginRuntimeManifestV10 extends Omit<PluginRuntimeManifestV9, '$schema' | 'schemaVersion' | 'capabilities'> {
  ...
  readonly capabilities: readonly (PluginRuntimeManifestV9['capabilities'][number] | ExtensionPointInteractionCapabilityV1 | ExtensionPointRenderCapabilityV1)[]
}
