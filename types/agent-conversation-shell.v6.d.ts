...
export type AgentConversationApprovalItem =
  | (AgentConversationApprovalItemBase & { state: 'pending'; agentGeneration: number; actions: AgentConversationPendingApprovalActions; diagnostic?: never })
  | (AgentConversationApprovalItemBase & { state: 'approved' | 'denied' | 'cancelled'; agentGeneration?: number; actions: readonly []; diagnostic?: never })
  | (AgentConversationApprovalItemBase & { state: 'failed'; agentGeneration?: number; actions: readonly []; diagnostic: LocalizedText })
