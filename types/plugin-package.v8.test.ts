...
const manifestSchema =
  'https://raw.githubusercontent.com/cordisx/cordisx-protocol/main/schemas/plugin-manifest.v8.schema.json' as const
const packageDocument = {
  ...
  compatibility: { runtimeAbi: 1, protocolSchemas: [manifestSchema] },
  dependencies: [],
  runtimeManifest: { path: './runtime.json', schema: manifestSchema, digest: `sha256:${'1'.repeat(64)}` },
} satisfies PluginRuntimePackageV8
