...
export interface AgentLoopTaskBinding {
  $schema: 'https://raw.githubusercontent.com/cordisx/cordisx-protocol/main/schemas/agent-loop-task-binding.v3.schema.json'
...
export type AgentLoopApprovalDecision = 'approve' | 'deny' | 'cancel'
...
export type AgentLoopResult =
  ...
  | (AgentLoopResultBase & { type: 'approval-decision'; status: 'accepted'; authorization: AgentLoopAllowedApprovalAuthorization; binding: AgentLoopTaskBinding; turn: string; approvalId: string; decision: AgentLoopApprovalDecision; delivery: AgentLoopDelivery })
  ...
  | (AgentLoopResultBase & { type: 'request-member-self-introduction'; status: 'accepted'; authorization: AgentLoopAllowedIntroductionAuthorization; binding: AgentLoopTaskBinding; participantId: string; memberId: string; runId: string; turn: string; messageId: string; delivery: AgentLoopDelivery })
...
export interface AgentLoopEventSubscription {
  $schema: 'https://raw.githubusercontent.com/cordisx/cordisx-protocol/main/schemas/agent-loop-event-subscription.v3.schema.json'
...
export interface AgentLoopEventPage {
  $schema: 'https://raw.githubusercontent.com/cordisx/cordisx-protocol/main/schemas/agent-loop-event-page.v3.schema.json'
...
export interface BoundAgentLoopClient {
  readonly $schema: 'https://raw.githubusercontent.com/cordisx/cordisx-protocol/main/schemas/agent-loop-bound-client.v3.schema.json'
  readonly contract: 'cordisx.bound-agent-loop-client/v3'
