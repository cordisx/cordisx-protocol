import type { AgentAdmissionBootstrapRoomTargetService, AgentAdmissionBootstrapRoomReservationService, AgentAdmissionBootstrapRoomTargetRequest, AgentAdmissionBootstrapRoomReservationRequest } from './agent-admission.v5.js'
