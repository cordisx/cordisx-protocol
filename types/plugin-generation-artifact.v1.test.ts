...
const artifact = {
  ...
  files: [
    { path: './module.js', kind: 'module', mediaType: 'text/javascript', digest, byteLength: 128, imports: ['./chunks/shared.js'], dynamicImports: ['./chunks/lazy.js'], styles: ['./styles/entry.css'], assets: [] },
    { path: './chunks/shared.js', kind: 'module', mediaType: 'text/javascript', digest, byteLength: 64, imports: [], dynamicImports: [], styles: [], assets: [] },
    { path: './chunks/lazy.js', kind: 'module', mediaType: 'text/javascript', digest, byteLength: 64, imports: ['./chunks/shared.js'], dynamicImports: [], styles: ['./styles/lazy.css'], assets: ['./images/icon.png'] },
    { path: './styles/entry.css', kind: 'stylesheet', mediaType: 'text/css', digest, byteLength: 32, assets: [] },
    { path: './styles/lazy.css', kind: 'stylesheet', mediaType: 'text/css', digest, byteLength: 32, assets: ['./fonts/body.woff2'] },
