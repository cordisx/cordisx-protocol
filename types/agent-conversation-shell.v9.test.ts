...
const context = { binding: origin.binding, generation: origin.generation, scope: 'composer-submit', command: { id: origin.commandId }, submitPayload: 'hello', origin } satisfies AgentConversationShellCommandContext
