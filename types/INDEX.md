...
- `agent-conversation-shell/v11`: [declarations](agent-conversation-shell.v11.d.ts), [persisted Room human input](../.agents/docs/agent-conversation-shell/README.md#v11-persisted-room-human-input).

- `agent-conversation-shell/v12`: [declarations](agent-conversation-shell.v12.d.ts), [persisted Session associations](../.agents/docs/agent-conversation-shell/README.md#v12-persisted-session-associations).
