...
} from './agent-conversation-shell.v6.js'
...
const composerSnapshot = {
  binding: { bindingId: 'binding-v6', ownerGeneration: 'owner-v6' },
  generation: 'shell-v6',
  snapshotSequence: 0,
...
void [composerSnapshot, unsupportedShortcut, terminalApproval, unboundPendingApproval, actionableTerminalApproval]
