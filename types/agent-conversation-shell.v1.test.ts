import type { AgentConversationParticipant, AgentConversationShellCommandContext, AgentConversationShellHost, AgentConversationShellSource } from '@cordisx/protocol/agent-conversation-shell/v1'
...
const participant: AgentConversationParticipant = { participantId: 'agent-1', role: 'agent', displayName: { key: 'agent.name', fallback: 'Agent' }, avatar: cloneAgentAvatarRef({ kind: 'asset', ref: 'asset:avatar-1', revision: 'revision:avatar-1' }) }
