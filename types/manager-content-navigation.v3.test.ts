...
const declaration = {
  ...
  header: { title: { kind: 'record', recordIdParam: 'memberId', fallback: { key: 'entity.unknown', fallback: 'Entity' } } },
  subject,
  recordSummary: {
  ...
  tabs: [{ id: 'overview', route: { id: 'entity-detail', params: { memberId: 'member-a' } }, label: { key: 'entity.overview', fallback: 'Overview' } }],
...
projection.recordSummary?.leadingVisual.avatar.kind satisfies 'generated' | 'asset' | 'definition' | 'platform' | undefined
